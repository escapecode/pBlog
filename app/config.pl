{
	...
	metaKeywords => 'blog, posts, pblog',					# Also for search engines...
	...
	commentsMaxLenght => 2000000,								# Comment maximum characters
	...
	searchMinLength => 3,									# Minimum length of the keyword to search, this is for avoiding seeking words like "and", "or", "a", etc
	...
	useHtmlOnEntries => 1,									# Allow HTML on entries when making a new post (THIS WILL DISALLOW BBCODE!!)
